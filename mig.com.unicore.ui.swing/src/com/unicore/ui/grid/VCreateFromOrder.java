 ...
 *
 */
public class VCreateFromOrder extends CreateFromOrder implements ActionListener, VetoableChangeListener {

	private VCreateFromDialog dialog;
	/**
	 * 
	 */
	public VCreateFromOrder(GridTab mTab) {
		super(mTab);
...
//		boolean seestock = isSeeStock.isSelected();
		...
		if (e.getSource().equals(requisitionField))
		{
			...
			loadOrder(C_Order_ID, (Integer) warehouseField.getValue());
		}
	 ...
	 *  @param M_Locator_ID
	 */
	protected void loadOrder (int M_Requisition_ID, int DestinationWarehouse_ID)
	{
	...
	{
		//  load BPartner
		int AD_Column_ID = COLUMN_C_ORDER_M_WAREHOUSE_ID;        //  C_Order.M_Warehouse_ID
