...
/** Generated Interface for UNS_BillingGroup_Result
 *  @author iDempiere (generated) 
 *  @version Release 2.1
 */
@SuppressWarnings("all")
public interface I_UNS_BillingGroup_Result 
{

    /** TableName=UNS_BillingGroup_Result */
    public static final String Table_Name = "UNS_BillingGroup_Result";
    ...
    /** Column name UNS_BillingGroup_Result_UU */
    public static final String COLUMNNAME_UNS_BillingGroup_Result_UU = "UNS_BillingGroup_Result_UU";

	/** Set UNS_BillingGroup_Result_UU	  */
	public void setUNS_BillingGroup_Result_UU (String UNS_BillingGroup_Result_UU);

	/** Get UNS_BillingGroup_Result_UU	  */
	public String getUNS_BillingGroup_Result_UU();
