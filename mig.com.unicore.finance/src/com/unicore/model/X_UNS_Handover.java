...
/** Generated Model for UNS_Handover
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_Handover extends PO implements I_UNS_Handover, I_Persistent 
{
    ...
    public X_UNS_Handover (Properties ctx, int UNS_Handover_ID, String trxName)
    {
      super (ctx, UNS_Handover_ID, trxName);
      /** if (UNS_Handover_ID == 0)
        {
...
// DR
			...
			setUNS_Handover_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UNS_Handover (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Handover[")
	...
	/** Set Handover.
		@param UNS_Handover_ID Handover	  */
	public void setUNS_Handover_ID (int UNS_Handover_ID)
	{
		if (UNS_Handover_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UNS_Handover_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UNS_Handover_ID, Integer.valueOf(UNS_Handover_ID));
	}

	/** Get Handover.
		@return Handover	  */
	public int getUNS_Handover_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UNS_Handover_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UNS_Handover_UU.
		@param UNS_Handover_UU UNS_Handover_UU	  */
	public void setUNS_Handover_UU (String UNS_Handover_UU)
	{
		set_Value (COLUMNNAME_UNS_Handover_UU, UNS_Handover_UU);
	}

	/** Get UNS_Handover_UU.
		@return UNS_Handover_UU	  */
	public String getUNS_Handover_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Handover_UU);
	}
}