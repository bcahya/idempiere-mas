...
// N
	...
	/** Set Is For NPWP Partner.
		@param IsForNPWPPartner 
		Is this rule applied for the partner with NPWP?
	  */
	public void setIsForNPWPPartner (boolean IsForNPWPPartner)
	{
		set_Value (COLUMNNAME_IsForNPWPPartner, Boolean.valueOf(IsForNPWPPartner));
	}

	/** Get Is For NPWP Partner.
		@return Is this rule applied for the partner with NPWP?
	  */
	public boolean isForNPWPPartner () 
	{
		Object oo = get_Value(COLUMNNAME_IsForNPWPPartner);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set LCO_WithholdingRule_UU.
		@param LCO_WithholdingRule_UU 
		LCO_WithholdingRule_UU
	  */
