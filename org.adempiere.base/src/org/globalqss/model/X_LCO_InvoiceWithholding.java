...
public class X_LCO_InvoiceWithholding extends PO implements I_LCO_InvoiceWithholding, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20160920L;
...
// N
	...
	/** Set Add To Grand Total.
		@param AddToGrandTotal 
		Add the calculated amount into the grand total amount.
	  */
	public void setAddToGrandTotal (boolean AddToGrandTotal)
	{
		set_ValueNoCheck (COLUMNNAME_AddToGrandTotal, Boolean.valueOf(AddToGrandTotal));
	}

	/** Get Add To Grand Total.
		@return Add the calculated amount into the grand total amount.
	  */
	public boolean isAddToGrandTotal () 
	{
		Object oo = get_Value(COLUMNNAME_AddToGrandTotal);
		if (oo != null) 
		{
	...
	/** Set LCO_InvoiceWithholding_UU.
		@param LCO_InvoiceWithholding_UU 
		LCO_InvoiceWithholding_UU
	  */
