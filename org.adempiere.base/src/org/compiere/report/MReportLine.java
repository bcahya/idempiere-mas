...
public class MReportLine extends X_PA_ReportLine
{
	...
	/** UNS Specific customization 		*/
	private String				m_periodWhereClause = null;
	
	/** UNS Specific of line's column specific definitions */
	private MReportLineColumns[] m_specificColumns = null;
	...
	//TAMBAHAN
	/**
	 * Get the specific column definitions of this line.
	 * @return
	 */
	public X_PA_ReportLineColumns[] getSpecificColumns()
	{
		return m_specificColumns;
	}
