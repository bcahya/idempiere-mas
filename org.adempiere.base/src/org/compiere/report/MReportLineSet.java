...
public class MReportLineSet extends X_PA_ReportLineSet
{
	...
	/** The Report line's summary. 	@UntaSoft@haryadi*/
	private MReportLineSummary[] m_lineSummaries = null;
	...
	//TAMBAHAN
	/**
	 * Get line's summaries of this report line set.
	 * 
	 * @return
	 */
	public MReportLineSummary[] getLineSummaries()
	{
		if (m_lineSummaries != null)
			return m_lineSummaries;
		
		List<MReportLineSummary> lineSums = new Query(
				getCtx(), MReportLineSummary.Table_Name, "PA_ReportLineSet_ID=?", get_TrxName())
				.setParameters(get_ID())
				.setOnlyActiveRecords(true)
				.setOrderBy(MReportLineSummary.COLUMNNAME_SeqNo)
				.list();
		
		m_lineSummaries = new MReportLineSummary[lineSums.size()];
		lineSums.toArray(m_lineSummaries);
