...
public class ProcessInfo implements Serializable
{
	...
	/** UNSCustomization@Harr - UNSMsgboxInfo to enable message box to be viewed */
	private UNSMsgboxInfo 		m_msgboxInfo = null;
	...
	public void setMsgboxInfo(UNSMsgboxInfo m_msgboxInfo) {
		this.m_msgboxInfo = m_msgboxInfo;
	}
