...
public class MBPartner extends X_C_BPartner
{
	...
	/**
	 * True if this is the partner with NPWP, that is the Tax ID column is filled with some numbers, 
	 * false otherwise.
	 * @return
	 */
	public boolean isNPWPPartner()
	{
		return Util.isEmpty(getTaxID(), true)? false : true;
	}
