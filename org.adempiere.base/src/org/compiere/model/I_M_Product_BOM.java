...
public interface I_M_Product_BOM 
{
    ...
    public static final String COLUMNNAME_FormulaType = "FormulaType";
	...
	/** Column name FormulaQty */
    public static final String COLUMNNAME_FormulaQty = "FormulaQty";

	/** Set Formula Qty.
	  * The quantity to calculate the exact numbers of this part to be used.
	  */
	...
	/** Column name FormulaRounding */
    public static final String COLUMNNAME_FormulaRounding = "FormulaRounding";
	...
	/** Column name FormulaPrecision */
    public static final String COLUMNNAME_FormulaPrecision = "FormulaPrecision";

	/** Set Formula Precision.
	  * The decimal precision of the formula.
	  */
