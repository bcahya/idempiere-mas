...
public class MBankAccount extends X_C_BankAccount
{
	...
	//TAMBAHAN
	public static MBankAccount getDefault(Properties ctx, int AD_Org_ID, String trxName)
	{
		MBankAccount account = null;
		account = new Query(ctx, Table_Name, COLUMNNAME_AD_Org_ID + "=? AND " + 
						COLUMNNAME_IsDefault + "=?", trxName).setParameters(AD_Org_ID, "Y")
