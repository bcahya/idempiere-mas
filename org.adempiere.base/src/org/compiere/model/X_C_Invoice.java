...
// N
	 ...
	 * Set Reference No.
	 * 
	 * @param ReferenceNo Your customer or vendor number at the Business Partner's
	 *                    site
	 */
	...
	/**
	 * Set Additional Discount Amt.
	 * 
	 * @param AddDiscountAmt The additional value discount being applied to this
	 *                       document transaction.
	 */
	public void setAddDiscountAmt(BigDecimal AddDiscountAmt) {
		set_Value(COLUMNNAME_AddDiscountAmt, AddDiscountAmt);
	}

	/**
	 * Get Additional Discount Amt.
	 * 
	 * @return The additional value discount being applied to this document
	 *         transaction.
	 */
	public BigDecimal getAddDiscountAmt() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_AddDiscountAmt);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}

	public org.compiere.model.I_AD_User getPrinted() throws RuntimeException
    {
		return (org.compiere.model.I_AD_User)MTable.get(getCtx(), org.compiere.model.I_AD_User.Table_Name)
			.getPO(getPrintedBy(), get_TrxName());	}

	/** Set Printed By.
		@param PrintedBy Printed By	  */
	 ...
	 * 
	 * @param CalculateDiscount Calculate Discount base Discount Schema
	 */
	public void setCalculateDiscount(String CalculateDiscount) {
		set_Value(COLUMNNAME_CalculateDiscount, CalculateDiscount);
	}

	/**
	 * Get Calculate Discount.
	 * 
	 * @return Calculate Discount base Discount Schema
	 */
	public String getCalculateDiscount() {
		return (String) get_Value(COLUMNNAME_CalculateDiscount);
	}

	public org.compiere.model.I_C_Invoice getCN_Invoice() throws RuntimeException
    {
		return (org.compiere.model.I_C_Invoice)MTable.get(getCtx(), org.compiere.model.I_C_Invoice.Table_Name)
			.getPO(getCN_Invoice_ID(), get_TrxName());	}

	/** Set Credit Note Invoice.
		@param CN_Invoice_ID Credit Note Invoice	  */
	public void setCN_Invoice_ID (int CN_Invoice_ID)
	{
		if (CN_Invoice_ID < 1) 
			set_Value (COLUMNNAME_CN_Invoice_ID, null);
		else 
			set_Value (COLUMNNAME_CN_Invoice_ID, Integer.valueOf(CN_Invoice_ID));
	}

	/** Get Credit Note Invoice.
		@return Credit Note Invoice	  */
	public int getCN_Invoice_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_CN_Invoice_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	 ...
	 * 
	 * @param AddDiscount The additional discount being applied to this document
	 *                    transaction in percent.
	 */
	public void setAddDiscount(BigDecimal AddDiscount) {
		set_Value(COLUMNNAME_AddDiscount, AddDiscount);
	}

	/**
	 * Get Additional Discount (%).
	 * 
	 * @return The additional discount being applied to this document transaction in
	 *         percent.
	 */
	public BigDecimal getAddDiscount() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_AddDiscount);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}
