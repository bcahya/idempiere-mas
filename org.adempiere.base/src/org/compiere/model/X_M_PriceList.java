...
// 2
	...
	//TAMBAHAN
	/** City To City = CC */
	public static final String PRICEBASED_CityToCity = "CC";
	/** Distance Of City = DC */
	public static final String PRICEBASED_DistanceOfCity = "DC";
	/** General Distance = GD */
	public static final String PRICEBASED_GeneralDistance = "GD";
	/** Set Price Based.
		@param PriceBased Price Based	  */
	public void setPriceBased (String PriceBased)
	{

		set_Value (COLUMNNAME_PriceBased, PriceBased);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PriceBased);
	}

	/** Volume = VL */
	public static final String BASICCALCULATION_Volume = "VL";
	/** Weight = WG */
	public static final String BASICCALCULATION_Weight = "WG";
	/** Wholesale = WS */
	public static final String BASICCALCULATION_Wholesale = "WS";
	/** Set Basic Calculation.
		@param BasicCalculation Basic Calculation	  */
	public void setBasicCalculation (String BasicCalculation)
	{

		set_Value (COLUMNNAME_BasicCalculation, BasicCalculation);
	}

	/** Get Basic Calculation.
		@return Basic Calculation	  */
	public String getBasicCalculation () 
	{
		return (String)get_Value(COLUMNNAME_BasicCalculation);
	}

	/** Expedition Price = EP */
	public static final String PRICETYPE_ExpeditionPrice = "EP";
	/** Product Price = PP */
	public static final String PRICETYPE_ProductPrice = "PP";
	/** Set Price Type.
