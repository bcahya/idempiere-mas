...
public interface I_M_PriceList 
{
	...
	//TAMBAHAN
	/** Column name PriceBased */
    public static final String COLUMNNAME_PriceBased = "PriceBased";
	...
	/** Column name BasicCalculation */
    public static final String COLUMNNAME_BasicCalculation = "BasicCalculation";
