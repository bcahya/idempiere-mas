...
// 5
	 ...
	 * Set Order Group.
	 * 
	 * @param UNS_OrderGroup_ID Order Group
	 */
	public void setUNS_OrderGroup_ID(int UNS_OrderGroup_ID) {
		if (UNS_OrderGroup_ID < 1)
			set_ValueNoCheck(COLUMNNAME_UNS_OrderGroup_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_UNS_OrderGroup_ID, Integer.valueOf(UNS_OrderGroup_ID));
	}
	 ...
	 * @return Order Group
	 */
	public int getUNS_OrderGroup_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_UNS_OrderGroup_ID);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
	 ...
	 * Set Lock Pricing.
	 * 
	 * @param IsLockPricing Lock Pricing
	 */
	public void setIsLockPricing(boolean IsLockPricing) {
		set_Value(COLUMNNAME_IsLockPricing, Boolean.valueOf(IsLockPricing));
	}
	 ...
	 * @return Lock Pricing
	 */
	public boolean isLockPricing() {
		Object oo = get_Value(COLUMNNAME_IsLockPricing);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
