...
public class MRequisition extends X_M_Requisition implements DocAction
{
	...
	//TAMBAHAN
	public static MRequisition getByPL(Properties ctx, int UNS_PackingList_ID, int M_Warehouse_ID, String trxName) {
		MRequisition req = null;
		String whereClause = COLUMNNAME_UNS_PackingList_ID + "=? AND " + COLUMNNAME_M_Warehouse_ID + "=?";
		req = new Query(ctx, Table_Name, whereClause, trxName).setParameters(UNS_PackingList_ID, M_Warehouse_ID)
				.first();
