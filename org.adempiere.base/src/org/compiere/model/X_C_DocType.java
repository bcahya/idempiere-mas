...
// N
	...
	//TAMBAHAN
	/** Charge Request = CHR */
	public static final String DOCBASETYPE_ChargeRequest = "CHR";
	/** Packing List Requisition = PLR */
	public static final String DOCBASETYPE_PackingListRequisition = "PLR";
	/** Loan Installment = LNI */
	public static final String DOCBASETYPE_LoanInstallment = "LNI";
	/** Cash Order = OC */
	public static final String DOCSUBTYPESO_CashOrder = "OC";
	/** Material Physical Inventory (Import) = MII */
	public static final String DOCBASETYPE_MaterialPhysicalInventoryImport = "MII";
	/** Payroll Employee = PRE */
	public static final String DOCBASETYPE_PayrollEmployee = "PRE";
	/** Material Movement Confirmation = MCO */
	public static final String DOCBASETYPE_MaterialMovementConfirmation = "MCO";
	/** Discount After Transaction = DAT */
	public static final String DOCBASETYPE_DiscountAfterTransaction = "DAT";
	/** Discount Target Bonus = DTB */
	public static final String DOCBASETYPE_DiscountTargetBonus = "DTB";
	/** Settlement = STL */
	public static final String DOCBASETYPE_Settlement = "STL";
	...
	//TAMBAHAN
	/**
	 * Set Extensions Handler.
	 * 
	 * @param ExtensionHandler The extensions to handle model (PO) invocation
	 */
	...
	/**
	 * Get Extensions Handler.
	 * 
	 * @return The extensions to handle model (PO) invocation
	 */
	public String getExtensionHandler() {
		return (String) get_Value(COLUMNNAME_ExtensionHandler);
	}
