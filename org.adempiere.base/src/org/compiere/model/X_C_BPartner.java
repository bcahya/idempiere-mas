...
// N
	 ...
	 * Set Is VAT Partner.
	 * 
	 * @param IsPKP To indicates if the transaction is VAT (Value Added Tax)
	 *              application.
	 */
	public void setIsPKP(boolean IsPKP) {
		set_Value(COLUMNNAME_IsPKP, Boolean.valueOf(IsPKP));
	}

	/**
	 * Get Is VAT Partner.
	 * 
	 * @return To indicates if the transaction is VAT (Value Added Tax) application.
	 */
	public boolean isPKP() {
		Object oo = get_Value(COLUMNNAME_IsPKP);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	/**
	 * Set VAT Doc on Trx Creation.
	 * 
	 * @param VATDocOnCreate To indicates if the VAT document will be automatically
	 *                       generated while saving invoice transaction.
	 */
	public void setVATDocOnCreate(boolean VATDocOnCreate) {
		set_Value(COLUMNNAME_VATDocOnCreate, Boolean.valueOf(VATDocOnCreate));
	}

	/**
	 * Get VAT Doc on Trx Creation.
	 * 
	 * @return To indicates if the VAT document will be automatically generated
	 *         while saving invoice transaction.
	 */
	public boolean isVATDocOnCreate() {
		Object oo = get_Value(COLUMNNAME_VATDocOnCreate);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	 ...
	 * Set Limited SO.
	 * 
	 * @param IsLimitedSO Limited SO
	 */
	public void setIsLimitedSO(boolean IsLimitedSO) {
		set_Value(COLUMNNAME_IsLimitedSO, Boolean.valueOf(IsLimitedSO));
	}
	 ...
	 * @return Limited SO
	 */
	public boolean isLimitedSO() {
		Object oo = get_Value(COLUMNNAME_IsLimitedSO);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	 ...
	 * 
	 * @param Limit_Discount Discount in percent to be subtracted from base, if
	 *                       negative it will be added to base price
	 */
	 ...
	 * 
	 * @return Discount in percent to be subtracted from base, if negative it will
...
public void setUNS_Outlet_Grade_ID (int UNS_Outlet_Grade_ID)
{
	 ...
	 * Set Owner Birthday.
	 * 
	 * @param OwnerBirthday Owner Birthday
	 */
	public void setOwnerBirthday(Timestamp OwnerBirthday) {
		set_Value(COLUMNNAME_OwnerBirthday, OwnerBirthday);
	}
	...
	public Timestamp getOwnerBirthday() {
		return (Timestamp) get_Value(COLUMNNAME_OwnerBirthday);
	}

	/**
	 * Set Owner ID Card No.
	 * 
	 * @param OwnerIDCardNo The ID card number of the owner (in Indonesia it is
	 *                      number of KTP)
	 */
	public void setOwnerIDCardNo(String OwnerIDCardNo) {
		set_Value(COLUMNNAME_OwnerIDCardNo, OwnerIDCardNo);
	}

	/**
	 * Get Owner ID Card No.
	 * 
	 * @return The ID card number of the owner (in Indonesia it is number of KTP)
	 */
	public String getOwnerIDCardNo() {
		return (String) get_Value(COLUMNNAME_OwnerIDCardNo);
	}

	/**
	 * Set Owner Name.
	 * 
	 * @param OwnerName The name of the owner of the business partner
	 */
