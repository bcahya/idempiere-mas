...
// B
	...
	//TAMBAHAN
	/** RequiresDocOnTrx AD_Reference_ID=287 */
	public static final int REQUIRESDOCONTRX_AD_Reference_ID=287;
	/** Both = B */
	public static final String REQUIRESDOCONTRX_Both = "B";
	/** Sales Tax = S */
	public static final String REQUIRESDOCONTRX_SalesTax = "S";
	/** Purchase Tax = P */
	public static final String REQUIRESDOCONTRX_PurchaseTax = "P";
	/** Set Requires Document On Transaction.
		@param RequiresDocOnTrx Requires Document On Transaction	  */
	public void setRequiresDocOnTrx (String RequiresDocOnTrx)
	{

		set_Value (COLUMNNAME_RequiresDocOnTrx, RequiresDocOnTrx);
	}

	/** Get Requires Document On Transaction.
		@return Requires Document On Transaction	  */
	public String getRequiresDocOnTrx () 
	{
		return (String)get_Value(COLUMNNAME_RequiresDocOnTrx);
	}
