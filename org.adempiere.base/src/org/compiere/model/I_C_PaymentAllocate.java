...
public interface I_C_PaymentAllocate 
{
	...
	//TAMBAHAN
	/** Column name PayToOverUnderAmount */
    public static final String COLUMNNAME_PayToOverUnderAmount = "PayToOverUnderAmount";

	/** Set Paid Amount.
	  * Fill into this field to set the payment and over/under payment (Invoice - Pay Amount)
	  */
