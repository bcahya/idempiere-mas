...
// E
	 ...
	 * Set Real/Full Name.
	 * 
	 * @param RealName Real/Full Name
	 */
	public void setRealName(String RealName) {
		set_Value(COLUMNNAME_RealName, RealName);
	}

	/**
	 * Get Real/Full Name.
	 * 
	 * @return Real/Full Name
	 */
	public String getRealName() {
		return (String) get_Value(COLUMNNAME_RealName);
	}
	 ...
	 * Set User Login.
	 * 
	 * @param IsUserLogin User Login
	 */
	public void setIsUserLogin(boolean IsUserLogin) {
		set_Value(COLUMNNAME_IsUserLogin, Boolean.valueOf(IsUserLogin));
	}
	...
	public boolean isUserLogin() {
		Object oo = get_Value(COLUMNNAME_IsUserLogin);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
