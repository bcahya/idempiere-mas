...
public class ProductCost
{
	...
	//TAMBAHAN
	/** Product Asset Intransit */
	public static final int ACCTTYPE_P_AssetIntransit = 25;
	/** Sales Product Bonus */
	public static final int ACCTTYPE_P_BonusSales	= 27;
	/** Sales Product Bonus Not Ship */
	public static final int ACCTTYPE_P_BonusSalesNotShip	= 29;
	/** Product Bonus */
	public static final int ACCTTYPE_P_Bonus		= 26;
	/** Product Bonus Not Receipt */
	public static final int ACCTTYPE_P_BonusNotReceipt = 28;
