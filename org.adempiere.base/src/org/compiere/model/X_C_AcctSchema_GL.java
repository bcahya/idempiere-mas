...
public class X_C_AcctSchema_GL extends PO implements I_C_AcctSchema_GL, I_Persistent 
{
	...
	//TAMBAHAN
	public I_C_ValidCombination getOffsetInitialValue_A() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getOffsetInitialValue_Acct(), get_TrxName());	}

	/** Set Offset Initial Value.
		@param OffsetInitialValue_Acct 
		The account combination to be used as default account for value initialization (i.e. while migrating material data and value)
	  */
	public void setOffsetInitialValue_Acct (int OffsetInitialValue_Acct)
	{
		set_Value (COLUMNNAME_OffsetInitialValue_Acct, Integer.valueOf(OffsetInitialValue_Acct));
	}

	/** Get Offset Initial Value.
		@return The account combination to be used as default account for value initialization (i.e. while migrating material data and value)
	  */
	public int getOffsetInitialValue_Acct () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_OffsetInitialValue_Acct);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
