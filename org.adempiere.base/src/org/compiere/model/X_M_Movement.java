...
// @#Date@
	...
	/**
	 * Set Internal Warehouse Confirmation.
	 * 
	 * @param IsInternalWarehouseConfirm This document need approval from internal
	 *                                   warehouse.
	 */
	public void setIsInternalWarehouseConfirm(boolean IsInternalWarehouseConfirm) {
		set_Value(COLUMNNAME_IsInternalWarehouseConfirm, Boolean.valueOf(IsInternalWarehouseConfirm));
	}

	/**
	 * Get Internal Warehouse Confirmation.
	 * 
	 * @return This document need approval from internal warehouse.
	 */
	public boolean isInternalWarehouseConfirm() {
		Object oo = get_Value(COLUMNNAME_IsInternalWarehouseConfirm);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	public org.compiere.model.I_M_Warehouse getDestinationWarehouse() throws RuntimeException
    {
		return (org.compiere.model.I_M_Warehouse)MTable.get(getCtx(), org.compiere.model.I_M_Warehouse.Table_Name)
			.getPO(getDestinationWarehouse_ID(), get_TrxName());	}

	/** Set Destination Warehouse.
		@param DestinationWarehouse_ID 
		Destination Warehouse
	  */
	public void setDestinationWarehouse_ID (int DestinationWarehouse_ID)
	{
		if (DestinationWarehouse_ID < 1) 
			set_Value (COLUMNNAME_DestinationWarehouse_ID, null);
		else 
			set_Value (COLUMNNAME_DestinationWarehouse_ID, Integer.valueOf(DestinationWarehouse_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DestinationWarehouse_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
