...
// 1
	 ...
	 * Set Product Bonuses.
	 * 
	 * @param isProductBonuses Product Bonuses
	 */
	 ...
	 * Set PPN Import.
	 * 
	 * @param PPNImport Total amount of PPN for imported content
	 */
	public void setPPNImport(BigDecimal PPNImport) {
		set_ValueNoCheck(COLUMNNAME_PPNImport, PPNImport);
	}

	/**
	 * Get PPN Import.
	 * 
	 * @return Total amount of PPN for imported content
	 */
	public BigDecimal getPPNImport() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_PPNImport);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}
	 ...
	 * Set PPh 22 Import.
	 * 
	 * @param PPh22Import Total amount of PPh 22 for imported content
	 */
