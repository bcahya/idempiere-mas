...
// S
	...
	/** Name = NME */
	public static final String COLUMNVALUE_Name = "NME";
	/** Value = VLU */
	public static final String COLUMNVALUE_Value = "VLU";
	/** Set Column Value.
		@param ColumnValue 
		Column Value To put in attribute description
	  */
	public void setColumnValue (String ColumnValue)
	{

		set_Value (COLUMNNAME_ColumnValue, ColumnValue);
	}

	/** Get Column Value.
		@return Column Value To put in attribute description
	  */
	public String getColumnValue () 
	{
		return (String)get_Value(COLUMNNAME_ColumnValue);
	}
