...
public interface I_M_AttributeSet 
{
	...
	//TAMBAHAN
	/** Column name IsUPC */
    public static final String COLUMNNAME_IsUPC = "IsUPC";

	/** Set Is For UPC.
	  * Is it for UPC attribute recording? If checked on Attribute Set the UPC is mandatory on every product transaction.
	  */
	...
	/** Column name UPCAttribute_ID */
    public static final String COLUMNNAME_UPCAttribute_ID = "UPCAttribute_ID";
	...
	/** Column name IsUniqueUPCPerUnit */
    public static final String COLUMNNAME_IsUniqueUPCPerUnit = "IsUniqueUPCPerUnit";

	/** Set UPC Unique Per Unit.
	  * To indicate that the UPC is unique for every unit item.
	  */
