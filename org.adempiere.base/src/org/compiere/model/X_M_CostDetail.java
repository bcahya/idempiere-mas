...
public class X_M_CostDetail extends PO implements I_M_CostDetail, I_Persistent 
{
	 ...
	 * Set Utilities Uses.
	 * 
	 * @param UNS_Utilities_Uses_ID Utilities Uses
	 */
	public void setUNS_Utilities_Uses_ID(int UNS_Utilities_Uses_ID) {
		if (UNS_Utilities_Uses_ID < 1)
			set_ValueNoCheck(COLUMNNAME_UNS_Utilities_Uses_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_UNS_Utilities_Uses_ID, Integer.valueOf(UNS_Utilities_Uses_ID));
	}

	/**
	 * Get Utilities Uses.
	 * 
	 * @return Utilities Uses
	 */
	public int getUNS_Utilities_Uses_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_UNS_Utilities_Uses_ID);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
