...
// I
	...
	/** Set UOM Conversion L1 Precision.
		@param UOMConversionL1Precision UOM Conversion L1 Precision	  */
	public void setUOMConversionL1Precision (int UOMConversionL1Precision)
	{
		set_Value (COLUMNNAME_UOMConversionL1Precision, Integer.valueOf(UOMConversionL1Precision));
	}

	/** Get UOM Conversion L1 Precision.
		@return UOM Conversion L1 Precision	  */
	public int getUOMConversionL1Precision () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UOMConversionL1Precision);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UOM Conversion L2 Precision.
		@param UOMConversionL2Precision UOM Conversion L2 Precision	  */
	public void setUOMConversionL2Precision (int UOMConversionL2Precision)
	{
		set_Value (COLUMNNAME_UOMConversionL2Precision, Integer.valueOf(UOMConversionL2Precision));
	}

	/** Get UOM Conversion L2 Precision.
		@return UOM Conversion L2 Precision	  */
	public int getUOMConversionL2Precision () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UOMConversionL2Precision);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UOM Conversion L3 Precision.
		@param UOMConversionL3Precision UOM Conversion L3 Precision	  */
	public void setUOMConversionL3Precision (int UOMConversionL3Precision)
	{
		set_Value (COLUMNNAME_UOMConversionL3Precision, Integer.valueOf(UOMConversionL3Precision));
	}

	/** Get UOM Conversion L3 Precision.
		@return UOM Conversion L3 Precision	  */
	public int getUOMConversionL3Precision () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UOMConversionL3Precision);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set UOM Conversion L4 Precision.
		@param UOMConversionL4Precision UOM Conversion L4 Precision	  */
	public void setUOMConversionL4Precision (int UOMConversionL4Precision)
	{
		set_Value (COLUMNNAME_UOMConversionL4Precision, Integer.valueOf(UOMConversionL4Precision));
	}

	/** Get UOM Conversion L4 Precision.
		@return UOM Conversion L4 Precision	  */
	public int getUOMConversionL4Precision () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UOMConversionL4Precision);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	 ...
	 * Set Gross Weight.
	 * 
	 * @param GrossWeight Weight of a product (Gross)
	 */
