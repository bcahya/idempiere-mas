...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM PA_ReportLine WHERE PA_ReportLineSet_ID=@PA_ReportLineSet_ID@
	...
	/**
	 * Set Report Line Summary.
	 * 
	 * @param PA_ReportLineSummary_ID Report Line Summary
	 */
	public void setPA_ReportLineSummary_ID(int PA_ReportLineSummary_ID) {
		if (PA_ReportLineSummary_ID < 1)
			set_ValueNoCheck(COLUMNNAME_PA_ReportLineSummary_ID, null);
		else
			set_ValueNoCheck(COLUMNNAME_PA_ReportLineSummary_ID, Integer.valueOf(PA_ReportLineSummary_ID));
	}

	/**
	 * Get Report Line Summary.
	 * 
	 * @return Report Line Summary
	 */
	public int getPA_ReportLineSummary_ID() {
		Integer ii = (Integer) get_Value(COLUMNNAME_PA_ReportLineSummary_ID);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
