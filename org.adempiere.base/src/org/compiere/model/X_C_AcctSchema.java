...
// -
	...
	//TAMBAHAN
	/**
	 * Set Ignored Unprocessed Price.
	 * 
	 * @param IsIgnoredUnprocessedPrice Ignored Unprocessed Price
	 */
	public void setIsIgnoredUnprocessedPrice(boolean IsIgnoredUnprocessedPrice) {
		set_Value(COLUMNNAME_IsIgnoredUnprocessedPrice, Boolean.valueOf(IsIgnoredUnprocessedPrice));
	}

	/**
	 * Get Ignored Unprocessed Price.
	 * 
	 * @return Ignored Unprocessed Price
	 */
	public boolean isIgnoredUnprocessedPrice() {
		Object oo = get_Value(COLUMNNAME_IsIgnoredUnprocessedPrice);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	/**
	 * Set Using Payroll Date For Sales Target And Incentive.
	 * 
	 * @param IsSTIUsingPayrollDate Using Payroll Date For Sales Target And
	 *                              Incentive
	 */
	public void setIsSTIUsingPayrollDate(boolean IsSTIUsingPayrollDate) {
		set_Value(COLUMNNAME_IsSTIUsingPayrollDate, Boolean.valueOf(IsSTIUsingPayrollDate));
	}

	/**
	 * Get Using Payroll Date For Sales Target And Incentive.
	 * 
	 * @return Using Payroll Date For Sales Target And Incentive
	 */
	public boolean isSTIUsingPayrollDate() {
		Object oo = get_Value(COLUMNNAME_IsSTIUsingPayrollDate);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
