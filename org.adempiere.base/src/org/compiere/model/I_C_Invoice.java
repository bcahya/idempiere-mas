...
public interface I_C_Invoice 
{
	...
	/** Column name AddDiscountAmt */
    public static final String COLUMNNAME_AddDiscountAmt = "AddDiscountAmt";

	/** Set Additional Discount Amt.
	  * The additional value discount being applied to this document transaction.
	  */
	...
	/** Column name CalculateDiscount */
    public static final String COLUMNNAME_CalculateDiscount = "CalculateDiscount";

	/** Set Calculate Discount.
	  * Calculate Discount base Discount Schema
	  */
	...
	/** Column name CN_Invoice_ID */
    public static final String COLUMNNAME_CN_Invoice_ID = "CN_Invoice_ID";
    ...
    public static final String COLUMNNAME_AddDiscount = "AddDiscount";

	/** Set Additional Discount (%).
	  * The additional discount being applied to this document transaction in percent.
	  */
