...
public interface I_C_Payment 
{
	...
	/** Column name VendorBeginningBalance */
    public static final String COLUMNNAME_VendorBeginningBalance = "VendorBeginningBalance";

	/** Set Beginning Balance.
	  * Vendor/Customer Balance prior to current payment transactions. Negative values means company still owed to the vendor.
	  */
    ...
    /** Column name VendorEndingBalance */
    public static final String COLUMNNAME_VendorEndingBalance = "VendorEndingBalance";

	/** Set Ending Balance.
	  * Vendor/Customer Balance after completing payment transactions.  Negative values means company still owed to the vendor.
	  */
