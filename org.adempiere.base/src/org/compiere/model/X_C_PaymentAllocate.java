...
public class X_C_PaymentAllocate extends PO implements I_C_PaymentAllocate, I_Persistent 
{
	 ...
	 * Set Paid Amount.
	 * 
	 * @param PayToOverUnderAmount Fill into this field to set the payment and
	 *                             over/under payment (Invoice - Pay Amount)
	 */
	public void setPayToOverUnderAmount(BigDecimal PayToOverUnderAmount) {
		set_Value(COLUMNNAME_PayToOverUnderAmount, PayToOverUnderAmount);
	}

	/**
	 * Get Paid Amount.
	 * 
	 * @return Fill into this field to set the payment and over/under payment
	 *         (Invoice - Pay Amount)
	 */
	public BigDecimal getPayToOverUnderAmount() {
		BigDecimal bd = (BigDecimal) get_Value(COLUMNNAME_PayToOverUnderAmount);
		if (bd == null)
			return Env.ZERO;
		return bd;
	}
