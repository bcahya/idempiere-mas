...
public class SystemIDs 
{
	...
	//TAMBAHAN
	public final static int COLUMN_C_INVOICE_SALESREP_ID = 3512;
	public final static int COLUMN_C_BPartner_BP_Group_ID = 4940;
	public final static int COLUMN_C_BPARTNER_LOCATION_UNS_RAYON_ID = 1003973;
	public final static int COLUMN_C_ORDER_M_WAREHOUSE_ID = 2202;
	public final static int COLUMN_UNS_BP_CANVASSER_M_LOCATOR_ID = 1006145;
	public final static int COLUMN_M_MOVEMENT_DESTINATIONWWAREHOUSE_ID = 1000637;
	public final static int COLUMN_AD_ORG_C_SALESREGION_ID = 1004013;
