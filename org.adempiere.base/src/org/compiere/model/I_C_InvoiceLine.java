...
public interface I_C_InvoiceLine 
{
	...
	/** Column name PPNImport */
    public static final String COLUMNNAME_PPNImport = "PPNImport";

	/** Set PPN Import.
	  * Total amount of PPN for imported content
	  */
    ...
    /** Column name ImportDutyPersent */
    public static final String COLUMNNAME_ImportDutyPersent = "ImportDutyPersent";
