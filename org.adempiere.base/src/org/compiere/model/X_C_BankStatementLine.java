...
// @StatementDate@
	...
	/** AP Transaction = APT */
	public static final String TRANSACTIONTYPE_APTransaction = "APT";
	/** AR Transaction = ART */
	public static final String TRANSACTIONTYPE_ARTransaction = "ART";
	...
	public void setUNS_TransferBalance_Request_ID(int UNS_TransferBalance_Request_ID) {
		if (UNS_TransferBalance_Request_ID < 1)
			...
			set_ValueNoCheck(COLUMNNAME_UNS_TransferBalance_Request_ID,
					Integer.valueOf(UNS_TransferBalance_Request_ID));
	}
	...
	public void setUNS_TransferBalance_Confirm_ID(int UNS_TransferBalance_Confirm_ID) {
		if (UNS_TransferBalance_Confirm_ID < 1)
			...
			set_ValueNoCheck(COLUMNNAME_UNS_TransferBalance_Confirm_ID,
					Integer.valueOf(UNS_TransferBalance_Confirm_ID));
	}
