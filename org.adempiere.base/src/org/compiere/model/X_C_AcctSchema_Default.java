...
public class X_C_AcctSchema_Default extends PO implements I_C_AcctSchema_Default, I_Persistent 
{
	...
	//TAMBAHAN
	/**
	 * Set Use Difference Account For Credit Write-off.
	 * 
	 * @param UseDiffAcctCreditWriteoff Use Difference Account For Credit Write-off
	 */
	public void setUseDiffAcctCreditWriteoff(boolean UseDiffAcctCreditWriteoff) {
		set_Value(COLUMNNAME_UseDiffAcctCreditWriteoff, Boolean.valueOf(UseDiffAcctCreditWriteoff));
	}

	/**
	 * Get Use Difference Account For Credit Write-off.
	 * 
	 * @return Use Difference Account For Credit Write-off
	 */
	public boolean isUseDiffAcctCreditWriteoff() {
		Object oo = get_Value(COLUMNNAME_UseDiffAcctCreditWriteoff);
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	public I_C_ValidCombination getWriteOffCredit_A() throws RuntimeException
    {
		return (I_C_ValidCombination)MTable.get(getCtx(), I_C_ValidCombination.Table_Name)
			.getPO(getWriteOffCredit_Acct(), get_TrxName());	}

	/** Set Credit Write-off.
		@param WriteOffCredit_Acct Credit Write-off	  */
	public void setWriteOffCredit_Acct (int WriteOffCredit_Acct)
	{
		set_Value (COLUMNNAME_WriteOffCredit_Acct, Integer.valueOf(WriteOffCredit_Acct));
	}

	/** Get Credit Write-off.
		@return Credit Write-off	  */
	public int getWriteOffCredit_Acct () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_WriteOffCredit_Acct);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
