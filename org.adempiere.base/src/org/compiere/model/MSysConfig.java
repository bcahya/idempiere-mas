...
public class MSysConfig extends X_AD_SysConfig
{
    ...
    //TAMBAHAN
    public static final String SET_ORG_WITH_ORG_EMPLOYEE_ON_SETTLEMENT = "SET_ORG_WITH_ORG_EMPLOYEE_ON_SETTLEMENT";
    public static final String CHECK_VAT_ON_BILLING = "CHECK_VAT_ON_BILLING";
    public static final String ZERO_DIFFERENCE_ON_TRF_ALLOCATION = "ZERO_DIFFERENCE_ON_TRF_ALLOCATION";
    public static final String VALIDATE_AMOUNT_REQUEST_ON_TB = "VALIDATE_AMOUNT_REQUEST_ON_TB";
    public static final String TOLERANCE_OF_DIFFERENCE_TIME = "TOLERANCE_OF_DIFFERENCE_TIME";
    public static final String INTRANSIT_MOVE_NEEDS_SUPERORDINATE_CONFIRMATION = "INTRANSIT_MOVE_NEEDS_SUPERORDINATE_CONFIRMATION";
    public static final String CHECK_DUPLICATE_ORDER = "CHECK_DUPLICATE_ORDER";
    public static final String INCLUDE_TAX_ON_DISCOUNT_CALCULATION = "INCLUDE_TAX_ON_DISCOUNT_CALCULATION";
    public static final String CHECK_DIFFERENCE_ON_INVOICE = "CHECK_DIFFERENCE_ON_INVOICE";
    public static final String CHECK_DIFFERENCE_ON_ORDER = "CHECK_DIFFERENCE_ON_ORDER";
    public static final String ON_TEST = "ON_TEST";
    public static final String SEE_TO_TMP_RECORD = "SEE_TO_TMP_RECORD";
    public static final String NEED_CONFIRM_CHARGE_ON_SHIPPING = "NEED_CONFIRMATION_CHARGE_ON_SHIPPING";
    public static final String MANDATORY_SHIPPING_ON_PACKING = "MANDATORY_SHIPPING_ON_PACKING";
    public static final String INCLUDE_TAX_ON_INCENTIVE_CALCULATION = "INCLUDE_TAX_ON_INCENTIVE_CALCULATION";
