...
public interface I_C_BPartner_Location 
{
	...
	/** Column name BPartnerSearchKey */
    public static final String COLUMNNAME_BPartnerSearchKey = "BPartnerSearchKey";

	/** Set BPartner Search Key.
	  * The search key of this record's business partner.
	  */
	...
	/** Column name UNS_Cluster_ID */
    public static final String COLUMNNAME_UNS_Cluster_ID = "UNS_Cluster_ID";
	...
	/** Column name UNS_Pasar_ID */
    public static final String COLUMNNAME_UNS_Pasar_ID = "UNS_Pasar_ID";
	...
	/** Set Latitude.
	  * The latitude of an area, minus means south otherwise point to north
	  */
	...
	/** Set Longitude.
	  * Longitude of an area. Minus value point to West, otherwise point to East.
	  */
