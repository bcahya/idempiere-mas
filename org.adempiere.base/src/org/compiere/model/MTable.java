...
public class MTable extends X_AD_Table
{
	...
	/** UNS Specific - Extension Handler */
	...
	//TAMBAHAN
	/**
	 * UNS Specific : Extension handler specified in the window this table call is attached.
	...
	/**
	 *  UNS Specific : Grid Tab specified in the window this table call is attached.
	 * @param mTab
	 */
	public void setGridTab (GridTab mTab)
	{
		super.setGridTab(mTab);
	}
