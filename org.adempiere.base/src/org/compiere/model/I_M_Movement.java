...
public interface I_M_Movement 
{
	...
	/** Column name IsInternalWarehouseConfirm */
    public static final String COLUMNNAME_IsInternalWarehouseConfirm = "IsInternalWarehouseConfirm";

	/** Set Internal Warehouse Confirmation.
	  * This document need approval from internal warehouse.
	  */
	...
	/** Column name DestinationWarehouse_ID */
    public static final String COLUMNNAME_DestinationWarehouse_ID = "DestinationWarehouse_ID";
