...
//	}   //  getM_Product_ID
	public int getM_Product_ID()
	{
		...
		if (index != -1)
		{
			MColumn column = MColumn.get(p_po.getCtx(), p_po.get_TableName(), "M_Product_ID");
...
//	}   //  getM_AttributeSetInstance_ID
	public int getM_AttributeSetInstance_ID()
	{
		...
		if (index != -1)
		{
			MColumn column = MColumn.get(p_po.getCtx(), p_po.get_TableName(), "M_AttributeSetInstance_ID");
...
//	}   //  getM_Locator_ID
	public int getM_Locator_ID()
	{
		...
		if (index != -1)
		{
			MColumn column = MColumn.get(p_po.getCtx(), p_po.get_TableName(), "M_Locator_ID");
	...
	public void setM_AttributesetInstance_ID ( int asi)
	{
		m_ASI_ID = asi;
	}
