...
/** Generated Model for UNS_IncentiveSchema
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_IncentiveSchema extends PO implements I_UNS_IncentiveSchema, I_Persistent 
{
    ...
    public X_UNS_IncentiveSchema (Properties ctx, int UNS_IncentiveSchema_ID, String trxName)
    {
      super (ctx, UNS_IncentiveSchema_ID, trxName);
      /** if (UNS_IncentiveSchema_ID == 0)
        {
			setC_Currency_ID (0);
			setC_Year_ID (0);
			setDocAction (null);
...
// SI
    ...
    /** Load Constructor */
    public X_UNS_IncentiveSchema (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_IncentiveSchema[")
	...
	/** Set UNS_IncentiveSchema_UU.
		@param UNS_IncentiveSchema_UU UNS_IncentiveSchema_UU	  */
	public void setUNS_IncentiveSchema_UU (String UNS_IncentiveSchema_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_IncentiveSchema_UU, UNS_IncentiveSchema_UU);
	}

	/** Get UNS_IncentiveSchema_UU.
		@return UNS_IncentiveSchema_UU	  */
	public String getUNS_IncentiveSchema_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_IncentiveSchema_UU);
	}
