...
/** Generated Model for UNS_Cvs_Rpt
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_Cvs_Rpt extends PO implements I_UNS_Cvs_Rpt, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20170330L;

    /** Standard Constructor */
    public X_UNS_Cvs_Rpt (Properties ctx, int UNS_Cvs_Rpt_ID, String trxName)
    {
...
// 0
    ...
    /** Load Constructor */
    public X_UNS_Cvs_Rpt (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Cvs_Rpt[")
	...
	/** Set Print ReportCVS.
		@param PrintReportCVS Print ReportCVS	  */
	public void setPrintReportCVS (String PrintReportCVS)
	{
		set_Value (COLUMNNAME_PrintReportCVS, PrintReportCVS);
	}

	/** Get Print ReportCVS.
		@return Print ReportCVS	  */
	public String getPrintReportCVS () 
	{
		return (String)get_Value(COLUMNNAME_PrintReportCVS);
	}
	...
	/** Set UNS_Cvs_Rpt_UU.
		@param UNS_Cvs_Rpt_UU UNS_Cvs_Rpt_UU	  */
	public void setUNS_Cvs_Rpt_UU (String UNS_Cvs_Rpt_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_Cvs_Rpt_UU, UNS_Cvs_Rpt_UU);
	}

	/** Get UNS_Cvs_Rpt_UU.
		@return UNS_Cvs_Rpt_UU	  */
	public String getUNS_Cvs_Rpt_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Cvs_Rpt_UU);
	}

	public com.unicore.model.I_UNS_Cvs_RptGroup getUNS_Cvs_RptGroup() throws RuntimeException
    {
		return (com.unicore.model.I_UNS_Cvs_RptGroup)MTable.get(getCtx(), com.unicore.model.I_UNS_Cvs_RptGroup.Table_Name)
			.getPO(getUNS_Cvs_RptGroup_ID(), get_TrxName());	}

	/** Set Canvas Report Group.
		@param UNS_Cvs_RptGroup_ID Canvas Report Group	  */
	public void setUNS_Cvs_RptGroup_ID (int UNS_Cvs_RptGroup_ID)
	{
		if (UNS_Cvs_RptGroup_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UNS_Cvs_RptGroup_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UNS_Cvs_RptGroup_ID, Integer.valueOf(UNS_Cvs_RptGroup_ID));
	}

	/** Get Canvas Report Group.
		@return Canvas Report Group	  */
	public int getUNS_Cvs_RptGroup_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UNS_Cvs_RptGroup_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
