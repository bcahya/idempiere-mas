...
/** Generated Model for UNS_Cvs_PhysicalProductMA
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_Cvs_PhysicalProductMA extends PO implements I_UNS_Cvs_PhysicalProductMA, I_Persistent 
{
    ...
    public X_UNS_Cvs_PhysicalProductMA (Properties ctx, int UNS_Cvs_PhysicalProductMA_ID, String trxName)
    {
      super (ctx, UNS_Cvs_PhysicalProductMA_ID, trxName);
      /** if (UNS_Cvs_PhysicalProductMA_ID == 0)
        {
...
// 1
    ...
    /** Load Constructor */
    public X_UNS_Cvs_PhysicalProductMA (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Cvs_PhysicalProductMA[")
    ...
    {
		return (com.unicore.model.I_UNS_Cvs_PhysicalProduct)MTable.get(getCtx(), com.unicore.model.I_UNS_Cvs_PhysicalProduct.Table_Name)
			.getPO(getUNS_Cvs_PhysicalProduct_ID(), get_TrxName());	}
	...
	/** Set UNS_Cvs_PhysicalProductMA_UU.
		@param UNS_Cvs_PhysicalProductMA_UU UNS_Cvs_PhysicalProductMA_UU	  */
	public void setUNS_Cvs_PhysicalProductMA_UU (String UNS_Cvs_PhysicalProductMA_UU)
	{
		set_Value (COLUMNNAME_UNS_Cvs_PhysicalProductMA_UU, UNS_Cvs_PhysicalProductMA_UU);
	}

	/** Get UNS_Cvs_PhysicalProductMA_UU.
		@return UNS_Cvs_PhysicalProductMA_UU	  */
	public String getUNS_Cvs_PhysicalProductMA_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Cvs_PhysicalProductMA_UU);
	}
}