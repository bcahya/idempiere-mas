...
/** Generated Model for UNS_PointSchema
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_PointSchema extends PO implements I_UNS_PointSchema, I_Persistent 
{
    ...
    public X_UNS_PointSchema (Properties ctx, int UNS_PointSchema_ID, String trxName)
    {
      super (ctx, UNS_PointSchema_ID, trxName);
      /** if (UNS_PointSchema_ID == 0)
        {
			setDocAction (null);
// CO
			setDocStatus (null);
// DR
    ...
    /** Load Constructor */
    public X_UNS_PointSchema (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_PointSchema[")
	...
	/** One Shipment = OS */
	public static final String POINTTYPE_OneShipment = "OS";
	/** Not One Shipment = NOS */
	public static final String POINTTYPE_NotOneShipment = "NOS";
	/** Set PointType.
		@param PointType PointType	  */
	public void setPointType (String PointType)
	{

		set_Value (COLUMNNAME_PointType, PointType);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PointType);
	}
