...
/** Generated Model for UNS_Checker_Result
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_Checker_Result extends PO implements I_UNS_Checker_Result, I_Persistent 
{
    ...
    public X_UNS_Checker_Result (Properties ctx, int UNS_Checker_Result_ID, String trxName)
    {
      super (ctx, UNS_Checker_Result_ID, trxName);
      /** if (UNS_Checker_Result_ID == 0)
        {
			setC_BPartner_ID (0);
			setCheckerType (null);
			setDocAction (null);
...
// DR
    ...
    /** Load Constructor */
    public X_UNS_Checker_Result (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Checker_Result[")
	...
	/** Set UNS_Checker_Result_UU.
		@param UNS_Checker_Result_UU UNS_Checker_Result_UU	  */
	public void setUNS_Checker_Result_UU (String UNS_Checker_Result_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_Checker_Result_UU, UNS_Checker_Result_UU);
	}

	/** Get UNS_Checker_Result_UU.
		@return UNS_Checker_Result_UU	  */
	public String getUNS_Checker_Result_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Checker_Result_UU);
	}
}