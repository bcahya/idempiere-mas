...
/** Generated Model for UNS_ShippingIncentiveSch
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_ShippingIncentiveSch extends PO implements I_UNS_ShippingIncentiveSch, I_Persistent 
{
    ...
    public X_UNS_ShippingIncentiveSch (Properties ctx, int UNS_ShippingIncentiveSch_ID, String trxName)
    {
      super (ctx, UNS_ShippingIncentiveSch_ID, trxName);
      /** if (UNS_ShippingIncentiveSch_ID == 0)
        {
			setC_Job_ID (0);
			setDocAction (null);
// CO
...
// DR
			setName (null);
			setUNS_ShippingIncentiveSch_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UNS_ShippingIncentiveSch (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_ShippingIncentiveSch[")
	...
	/** Helper 1 = HP2 */
	public static final String CREWTYPE_Helper1 = "HP2";
	/** Helper 2 = Hp2 */
	public static final String CREWTYPE_Helper2 = "Hp2";
	/** Set Crew Type.
	...
	/** Set Shipping Incentive Schema UU.
		@param UNS_ShippingIncentiveSch_UU Shipping Incentive Schema UU	  */
	public void setUNS_ShippingIncentiveSch_UU (String UNS_ShippingIncentiveSch_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_ShippingIncentiveSch_UU, UNS_ShippingIncentiveSch_UU);
	}

	/** Get Shipping Incentive Schema UU.
		@return Shipping Incentive Schema UU	  */
	public String getUNS_ShippingIncentiveSch_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_ShippingIncentiveSch_UU);
	}
