...
/** Generated Interface for UNS_Checker_Result
 *  @author iDempiere (generated) 
 *  @version Release 2.1
 */
@SuppressWarnings("all")
public interface I_UNS_Checker_Result 
{

    /** TableName=UNS_Checker_Result */
    public static final String Table_Name = "UNS_Checker_Result";
    ...
    /** Column name CheckerType */
    public static final String COLUMNNAME_CheckerType = "CheckerType";
    ...
    /** Column name isDefinedCost */
    public static final String COLUMNNAME_isDefinedCost = "isDefinedCost";
    ...
    /** Column name UNS_Checker_Result_ID */
    public static final String COLUMNNAME_UNS_Checker_Result_ID = "UNS_Checker_Result_ID";
    ...
    /** Column name UNS_Checker_Result_UU */
    public static final String COLUMNNAME_UNS_Checker_Result_UU = "UNS_Checker_Result_UU";

	/** Set UNS_Checker_Result_UU	  */
	public void setUNS_Checker_Result_UU (String UNS_Checker_Result_UU);

	/** Get UNS_Checker_Result_UU	  */
	public String getUNS_Checker_Result_UU();
