...
public class MUNSCustomerRedeem extends X_UNS_CustomerRedeem implements DocAction {
	...
	public String completeIt()
	{
		...
		MUNSCustomerRedeemLine cRedeem = new MUNSCustomerRedeemLine(getCtx(), 0, get_TrxName());
		
		if (cRedeem.getByParent(get_ID(), get_TrxName()).length == 0)
			throw new AdempiereException("Failed: Please Define Redeem Reward");
