...
/** Generated Model for UNS_Handover_Document
 *  @author iDempiere (generated) 
 *  @version Release 2.1 - $Id$ */
public class X_UNS_Handover_Document extends PO implements I_UNS_Handover_Document, I_Persistent 
{
    ...
    public X_UNS_Handover_Document (Properties ctx, int UNS_Handover_Document_ID, String trxName)
    {
      super (ctx, UNS_Handover_Document_ID, trxName);
      /** if (UNS_Handover_Document_ID == 0)
        {
			setC_DocType_ID (0);
			setDocAction (null);
// CO
...
// DR
			setProcessed (false);
			setUNS_Handover_Document_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UNS_Handover_Document (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Handover_Document[")
	...
	/** Set UNS_Handover_Document_UU.
		@param UNS_Handover_Document_UU UNS_Handover_Document_UU	  */
	public void setUNS_Handover_Document_UU (String UNS_Handover_Document_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_Handover_Document_UU, UNS_Handover_Document_UU);
	}

	/** Get UNS_Handover_Document_UU.
		@return UNS_Handover_Document_UU	  */
	public String getUNS_Handover_Document_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Handover_Document_UU);
	}
