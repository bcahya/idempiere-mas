...
/** Generated Interface for UNS_Audit
 *  @author iDempiere (generated) 
 *  @version Release 2.1
 */
@SuppressWarnings("all")
public interface I_UNS_Audit 
{

    /** TableName=UNS_Audit */
    public static final String Table_Name = "UNS_Audit";
    ...
    /** Column name UNS_Audit_UU */
    public static final String COLUMNNAME_UNS_Audit_UU = "UNS_Audit_UU";

	/** Set UNS_Audit_UU	  */
	public void setUNS_Audit_UU (String UNS_Audit_UU);

	/** Get UNS_Audit_UU	  */
	public String getUNS_Audit_UU();
