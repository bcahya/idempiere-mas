...
/** Generated Model for UNS_BongkarMuat
 *  @author iDempiere (generated) 
 *  @version Release 1.0a - $Id$ */
public class X_UNS_BongkarMuat extends PO implements I_UNS_BongkarMuat, I_Persistent 
{
    ...
    public X_UNS_BongkarMuat (Properties ctx, int UNS_BongkarMuat_ID, String trxName)
    {
      super (ctx, UNS_BongkarMuat_ID, trxName);
      /** if (UNS_BongkarMuat_ID == 0)
        {
			setC_DocType_ID (0);
			setCreateFrom (null);
// N
...
// N
			...
			setWorkerResultType (null);
// GRR
        } */
    }

    /** Load Constructor */
    public X_UNS_BongkarMuat (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_BongkarMuat[")
	...
	/** Set Hours Over Time.
		@param HoursOverTime Hours Over Time	  */
	...
	/** Set Over Time Production.
		@param IsOverTime Over Time Production	  */
	public void setIsOverTime (boolean IsOverTime)
	{
		set_Value (COLUMNNAME_IsOverTime, Boolean.valueOf(IsOverTime));
	}

	/** Get Over Time Production.
		@return Over Time Production	  */
	...
	/** Set Ref Bongkar Muat.
		@param Ref_UNS_BongkarMuat_ID Ref Bongkar Muat	  */
	public void setRef_UNS_BongkarMuat_ID (int Ref_UNS_BongkarMuat_ID)
	{
		if (Ref_UNS_BongkarMuat_ID < 1) 
			set_Value (COLUMNNAME_Ref_UNS_BongkarMuat_ID, null);
		else 
			set_Value (COLUMNNAME_Ref_UNS_BongkarMuat_ID, Integer.valueOf(Ref_UNS_BongkarMuat_ID));
	}

	/** Get Ref Bongkar Muat.
		@return Ref Bongkar Muat	  */
	public int getRef_UNS_BongkarMuat_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Ref_UNS_BongkarMuat_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public com.uns.model.I_UNS_BongkarMuat getReversal() throws RuntimeException
    {
	...
	/** Set uns_bongkarmuat_uu.
		@param uns_bongkarmuat_uu uns_bongkarmuat_uu	  */
	public void setuns_bongkarmuat_uu (String uns_bongkarmuat_uu)
	{
		set_Value (COLUMNNAME_uns_bongkarmuat_uu, uns_bongkarmuat_uu);
	}

	/** Get uns_bongkarmuat_uu.
		@return uns_bongkarmuat_uu	  */
	public String getuns_bongkarmuat_uu () 
	{
		return (String)get_Value(COLUMNNAME_uns_bongkarmuat_uu);
	}
	...
	/** WorkerResultType AD_Reference_ID=1000087 */
	public static final int WORKERRESULTTYPE_AD_Reference_ID=1000087;
	/** Daily = DAY */
