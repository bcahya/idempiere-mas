...
/** Generated Model for UNS_PrematureConfirmation
 *  @author iDempiere (generated) 
 *  @version Release 1.0a - $Id$ */
public class X_UNS_PrematureConfirmation extends PO implements I_UNS_PrematureConfirmation, I_Persistent 
{
    ...
    public X_UNS_PrematureConfirmation (Properties ctx, int UNS_PrematureConfirmation_ID, String trxName)
    {
      super (ctx, UNS_PrematureConfirmation_ID, trxName);
      /** if (UNS_PrematureConfirmation_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_UNS_PrematureConfirmation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_PrematureConfirmation[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_Reason, Reason);
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_RequestedDate, RequestedDate);
	}
	...
	/** Set UNS_PrematureConfirmation_UU.
		@param UNS_PrematureConfirmation_UU UNS_PrematureConfirmation_UU	  */
	public void setUNS_PrematureConfirmation_UU (String UNS_PrematureConfirmation_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_PrematureConfirmation_UU, UNS_PrematureConfirmation_UU);
	}

	/** Get UNS_PrematureConfirmation_UU.
		@return UNS_PrematureConfirmation_UU	  */
	public String getUNS_PrematureConfirmation_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_PrematureConfirmation_UU);
	}
