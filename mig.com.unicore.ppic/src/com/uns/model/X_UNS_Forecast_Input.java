...
/** Generated Model for UNS_Forecast_Input
 *  @author iDempiere (generated) 
 *  @version Release 1.0a - $Id$ */
public class X_UNS_Forecast_Input extends PO implements I_UNS_Forecast_Input, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20130323L;

    /** Standard Constructor */
    public X_UNS_Forecast_Input (Properties ctx, int UNS_Forecast_Input_ID, String trxName)
    {
      super (ctx, UNS_Forecast_Input_ID, trxName);
      /** if (UNS_Forecast_Input_ID == 0)
        {
			setC_UOM_ID (0);
			setM_Product_ID (0);
			setUNS_Forecast_Header_ID (0);
			setUNS_Forecast_Input_ID (0);
        } */
    }

    /** Load Constructor */
    public X_UNS_Forecast_Input (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_UNS_Forecast_Input[")
	...
	/** Set Forecast Input.
		@param UNS_Forecast_Input_ID Forecast Input	  */
	public void setUNS_Forecast_Input_ID (int UNS_Forecast_Input_ID)
	{
		if (UNS_Forecast_Input_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_UNS_Forecast_Input_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_UNS_Forecast_Input_ID, Integer.valueOf(UNS_Forecast_Input_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_UNS_Forecast_Input_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Forecast Input UU.
		@param UNS_Forecast_Input_UU Forecast Input UU	  */
	public void setUNS_Forecast_Input_UU (String UNS_Forecast_Input_UU)
	{
		set_ValueNoCheck (COLUMNNAME_UNS_Forecast_Input_UU, UNS_Forecast_Input_UU);
	}

	/** Get Forecast Input UU.
		@return Forecast Input UU	  */
	public String getUNS_Forecast_Input_UU () 
	{
		return (String)get_Value(COLUMNNAME_UNS_Forecast_Input_UU);
	}
}